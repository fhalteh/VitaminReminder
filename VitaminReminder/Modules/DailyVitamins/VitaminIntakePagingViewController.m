...
- (void)updateViewControllerWithDayChange:(DayChange)dayChange {
    DailyVitaminTableViewController *viewController = self.viewControllers.firstObject;
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    NSDate *currentDate = ((DailyVitaminTableViewController *)viewController).currentDate;
...
- (UIViewController *)createViewControllerWithDate:(NSDate *)date {
    DailyVitaminTableViewController *viewController = [[DailyVitaminTableViewController alloc] initWithStorageManager:self.storageManager];
...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray<UIViewController *> *)previousViewControllers transitionCompleted:(BOOL)completed {
    if (completed) {
        NSDate *updatedDate = ((DailyVitaminTableViewController *)pageViewController.viewControllers.firstObject).currentDate;
